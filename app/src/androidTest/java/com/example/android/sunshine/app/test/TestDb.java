...
//        String[] columns2 = {WeatherEntry._ID,
...
//                WeatherEntry.COLUMN_WEATHER_ID};
        Cursor cursor2 = db.query(WeatherEntry.TABLE_NAME,
                null,
                null, null, null, null, null);
        if (cursor2.moveToFirst()) {
//            int locKey = cursor2.getInt(cursor2.getColumnIndex(WeatherEntry.COLUMN_LOC_KEY));
//            String dateText = cursor2.getString(cursor2.getColumnIndex(WeatherEntry.COLUMN_DATETEXT));
//            double degrees = cursor2.getDouble(cursor2.getColumnIndex(WeatherEntry.COLUMN_DEGREES));
//            double humidity = cursor2.getDouble(cursor2.getColumnIndex(WeatherEntry.COLUMN_HUMIDITY));
//            double pressure = cursor2.getDouble(cursor2.getColumnIndex(WeatherEntry.COLUMN_PRESSURE));
//            double maxTemp = cursor2.getDouble(cursor2.getColumnIndex(WeatherEntry.COLUMN_MAX_TEMP));
//            double minTemp = cursor2.getDouble(cursor2.getColumnIndex(WeatherEntry.COLUMN_MIN_TEMP));
//            String shortDesc = cursor2.getString(cursor2.getColumnIndex(WeatherEntry.COLUMN_SHORT_DESC));
//            double windSpeed = cursor2.getDouble(cursor2.getColumnIndex(WeatherEntry.COLUMN_WIND_SPEED));
//            int weatherId = cursor2.getInt(cursor2.getColumnIndex(WeatherEntry.COLUMN_WEATHER_ID));
//
...
//            assertEquals(75.0, maxTemp);
//            assertEquals(65.0, minTemp);
//            assertEquals("Asteroids", shortDesc);
//            assertEquals(5.5, windSpeed);
//            assertEquals(321, weatherId);
            validateCursor(cursor2, weatherValues);
        } else {
            fail("No values returned :(");
        }
