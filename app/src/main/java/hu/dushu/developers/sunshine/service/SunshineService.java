//package hu.dushu.developers.sunshine.service;
//
...
//        String[] result;
//
//        String locationSetting = intent.getStringExtra(LOCATION_QUERY_EXTRA);
...
//        }
//
//        getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI,
...
//            values.put(WeatherContract.LocationEntry.COLUMN_COORD_LONG, lon);
//
//            Uri uri = getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI,
//                    values);
